...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="nav-links">
      <a href="../sessions/view.php"><span><i class="fas fa-calendar-alt"></i></span> My Sessions</a>
      <a href="../feedback/view_all_tutor.php"><span><i class="fas fa-star"></i></span> Feedback</a>
      <a href="../notifications/view_all.php"><span><i class="fas fa-bell"></i></span> Notifications</a>
      <a href="../profile/tutor.php"><span><i class="fas fa-user"></i></span> My Profile</a>
  ...
  <div class="main">
    <div class="welcome-section">
      <h1>Welcome back, <?= htmlspecialchars($tutorName); ?>! <i class="fas fa-hand-wave"></i></h1>
    ...
    <div class="stats">
      ...
      <div class="stat-card">
        <span class="stat-card-icon"><i class="fas fa-bell"></i></span>
        <h2><?= $noteCount; ?></h2>
          ...
          <ul>
            <?php while($n = $notes->fetch_assoc()): ?>
              <li class="<?= !$n['is_read'] ? 'unread' : ''; ?>">
                ...
                <small><i class="fas fa-calendar-alt"></i> <?= date("d M Y, H:i", strtotime($n['created_at'])); ?></small>
              </li>
            <?php endwhile; ?>
          </ul>
          ...
          <ul>
            <?php while($s = $sessions->fetch_assoc()): ?>
              <li>
                ...
                <div class="session-info">🕐 <?= date("d M Y, H:i", strtotime($s['start_time'])); ?> - <?= date("H:i", strtotime($s['end_time'])); ?></div>
              </li>
            <?php endwhile; ?>
          </ul>
          <div class="action-links">
            <a href="../sessions/view.php" class="link">View All Sessions →</a>
          </div>
        <?php else: ?>
          ...
          <ul>
            <?php while($c = $completed->fetch_assoc()): ?>
              <li>
                ...
                <div class="session-info"><i class="fas fa-clock"></i> Completed: <?= date("d M Y, H:i", strtotime($c['end_time'])); ?></div>
              </li>
            <?php endwhile; ?>
          </ul>
          <div class="action-links">
            <a href="../sessions/completed.php" class="link">View All Completed →</a>
          </div>
        <?php else: ?>
    ...
    <div class="box">
      <div class="box-header">
        <h3><span><i class="fas fa-star"></i></span> Recent Feedback</h3>
      </div>
      <div class="box-content">
          ...
          <ul>
            <?php while($f = $feedback->fetch_assoc()): ?>
              <li>
                ...
                <div class="session-info"><i class="fas fa-user"></i> Student: <?= htmlspecialchars($f['first_name']." ".$f['last_name']); ?></div>
        ...
        <?php else: ?>
          <div class="empty-state"><i class="fas fa-inbox"></i> No feedback yet</div>
        <?php endif; ?>
      </div>
    </div>
